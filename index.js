 ...
 * Homepage: https://shopilo.it/negozi/itabus.it
 */

const SHOPILO_URL = "https://shopilo.it/negozi/itabus.it";
const STORE_NAME  = "Itabus";

async function fetchCoupons(url = SHOPILO_URL) {
  const res = await fetch(url, {
    headers: { "User-Agent": "coupon-fetcher/1.0 (+https://github.com/shopilo-it/codice-sconto-itabus)" }
  });
