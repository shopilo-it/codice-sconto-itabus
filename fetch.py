#!/usr/bin/env python3
"""
Recupero codici sconto Itabus da shopilo.it
Sursa: https://shopilo.it/negozi/itabus.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/itabus.it"
STORE_NAME = "Itabus"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Itabus da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-itabus)"
    }
    try:
